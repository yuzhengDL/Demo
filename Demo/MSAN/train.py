...
tf.flags.DEFINE_string("checkpoint_dir", "checkpoints/", "checkpoint_path")
tf.flags.DEFINE_string("dataset_dir", "", "dataset path")
...
def main():
	...
	(train_caps, train_ims_local, train_ims_global), (test_caps, test_ims_local, test_ims_global) = load_dataset(path=FLAGS.dataset_dir, name=model_config.data, load_train=True)
	...
	with open('coco.dictionary.pkl', 'wb') as f:
            pkl.dump(worddict, f)
